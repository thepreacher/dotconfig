...
(defvar nap/gc-cons-threshold 100000000)


(add-hook 'emacs-startup-hook ; hook run after loading init files
	  #'(lambda ()
	      (setq gc-cons-threshold nap/gc-cons-threshold
...
(use-package lsp-python-ms
  ...
  (setq lsp-python-ms-dir
	(expand-file-name "~/lang-servers/python-language-server/output/bin/Release/"))
  ;; for executable of language server, if it's not symlinked on your PATH
  ;; https://github.com/emacs-lsp/lsp-python-ms
  (setq lsp-python-ms-executable
	(expand-file-name "~/lang-servers/python-language-server/output/bin/Release/osx-x64/publish/Microsoft.Python.LanguageServer"))
  :custom
